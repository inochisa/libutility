...
#ifndef __UTILITY_TRAIT_TYPE_TRANSFORM__
#define __UTILITY_TRAIT_TYPE_TRANSFORM__
...
#include<utility/trait/type/transform/remove_all.hpp>
#include<utility/trait/type/transform/decay.hpp>

#endif // ! __UTILITY_TRAIT_TYPE_TRANSFORM__
