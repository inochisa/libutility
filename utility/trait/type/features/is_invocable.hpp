  ...
  namespace trait
  {
    namespace type
    {
      namespace feature
      {
        ...
        {
          using namespace utility::trait::type::miscellaneous::__invoke_related;
          using utility::trait::void_t;
          using utility::trait::__type_and__;
          ...
          struct __is_invocable_helper<true, _Res, _T, void_t<typename _Res::type>> :
            public utility::trait::integral_constant<bool,
              utility::trait::type::releations::is_convertible<typename _Res::type, _T>::value>
          { };
          ...
          struct __is_noexcept_invoke_test<__invoke_member_function_unpacked, _Fn, _Arg, _Args...>
          {
            ...
            public:
              constexpr static bool value = noexcept(((utility::trait::type::special::declval<_Ori>()).*utility::trait::type::special::declval<_Fn>())(utility::trait::type::special::declval<_Args>()...));
          };
          template<typename _Fn, typename _Arg, typename... _Args>
          struct __is_noexcept_invoke_test<__invoke_member_function_packed, _Fn, _Arg, _Args...>
          {
            public:
              constexpr static bool value = noexcept(((*utility::trait::type::special::declval<_Arg>()).*utility::trait::type::special::declval<_Fn>())(utility::trait::type::special::declval<_Args>()...));
          };
          template<typename _Fn, typename _Arg, typename... _Args>
          struct __is_noexcept_invoke_test<__invoke_member_object_unpacked, _Fn, _Arg, _Args...>
          {
            private:
              typedef typename __wrapper<_Arg, typename __decay<_Arg>::type>::type _Ori;
            public:
              constexpr static bool value = noexcept(utility::trait::type::special::declval<_Ori>().*utility::trait::type::special::declval<_Fn>());
          };
          template<typename _Fn, typename _Arg, typename... _Args>
          struct __is_noexcept_invoke_test<__invoke_member_object_packed, _Fn, _Arg, _Args...>
          {
            public:
              constexpr static bool value = noexcept((*utility::trait::type::special::declval<_Arg>()).*utility::trait::type::special::declval<_Fn>());
          };
          template<typename _Fn, typename... _Args>
          struct __is_noexcept_invoke_test<__invoke_operators, _Fn, _Args...>
          {
            public:
              constexpr static bool value = noexcept(utility::trait::type::special::declval<_Fn>()(utility::trait::type::special::declval<_Args>()...));
          };
