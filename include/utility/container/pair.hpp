    ...
    */
    ...
    class pair
    {
      ...
      public:
        ...
        template<typename _U1, typename _U2,
        typename trait::type::miscellaneous::enable_if<
            trait::type::features::is_assignable<_T1&, const _U1&>::value &&
            trait::type::features::is_assignable<_T2&, const _U2&>::value,
          bool>::type = true
        >
      ...
      public:
        ...
        template<typename _U1, typename _U2,
          typename trait::type::miscellaneous::enable_if<
            trait::type::features::is_assignable<_T1&, _U1&&>::value &&
            trait::type::features::is_assignable<_T2&, _U2&&>::value,
          bool>::type = true
        >
      ...
      public:
        template<typename _U1 = _T1, typename _U2 = _T2,
        typename trait::type::miscellaneous::enable_if<
          trait::type::features::is_swappable<_U1>::value &&
          trait::type::features::is_swappable<_U2>::value,
        bool>::type = true
        >
        ...
        template<typename _U1 = _T1, typename _U2 = _T2,
          typename trait::type::miscellaneous::enable_if<
            trait::type::features::is_possible_swappable<_U1>::value &&
            trait::type::features::is_possible_swappable<_U2>::value,
          bool>::type = true
        >
        void possible_swap(pair& __other) noexcept(
          trait::type::features::is_nothrow_possible_swappable<_T1>::value &&
          trait::type::features::is_nothrow_possible_swappable<_T2>::value)
        {
