...
#ifndef __UTILITY_ALGORITHM_LOWER_BOUND__
#define __UTILITY_ALGORITHM_LOWER_BOUND__
...
namespace utility
{
  namespace algorithm
  {
     ...
     * [\a __first, \a __last) that is not less than \a __val.
     *
    ...
    /**
     * \overload _ForwardIterator lower_bound(
     *   _ForwardIterator __first, _ForwardIterator __last,
     *   const _T& __val
     * )
     *
...
#endif // ! __UTILITY_ALGORITHM_LOWER_BOUND__
