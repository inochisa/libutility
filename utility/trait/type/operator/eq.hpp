        ...
        namespace __eq_impl
        {
          ...
          struct __eq_test
          {
            private:
              ...
              static char __test(const __T&,decltype(operator==(utility::trait::type::special::declval<_T>(),utility::trait::type::special::declval<_U>()))* = 0);
              template<typename __T, typename __U>
              static __two __test(...);

            public:
              constexpr static bool value = sizeof(char) ==
                sizeof(decltype(__test<_T, _U>(utility::trait::type::special::declval<_T>())));
          };
        }
